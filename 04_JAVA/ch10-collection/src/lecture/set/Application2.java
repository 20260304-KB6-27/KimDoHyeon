...
public class Application2 {
    public static void main(String[] args) {
        ...
        *
        * */
        System.out.println("tset.floor(25) = " + tset.floor(25)); // 25 이하인 요소중 가장 큰 값
        System.out.println("tset.lower(20) = " + tset.lower(20)); // 25 미만인 요소중 가장 큰 값
        
        /*
        * headSet(e): e 미만인 요소들로 구성된 set 반환
        * tailSet(e): e 이상인 요소들로 구성도니 set 반환
